            ...
            <table class="equipo-table">
                ...
                <tbody>
                    <tr class="equipo-row">
                        ...
                        <td>
                            <p class="biografia-text">Arquitecto especializado en diseño minimalista y sostenible...</p>
                        </td>
                    ...
                    <tr class="equipo-row">
                        <td>
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <div style="font-weight: bold;">{{ Auth::user()->nombre ?? 'Luis Roberto Flores' }}</div>
                                    <div style="font-size: 0.75rem; color: #888; font-family: Arial;">Admin / Desarrollador</div>
                                </div>
                            </div>
                        </td>
                        <td>
                            <p class="biografia-text">Ingeniero encargado de la infraestructura digital y automatización para el despacho.</p>
                        </td>
                        <td style="text-align: right;">
                            <button class="btn-action-minimal">Editar</button>
                            <button class="btn-action-minimal" style="color: #d9534f;">Eliminar</button>
