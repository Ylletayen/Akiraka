<div class="akira-scroll-container" id="scroll-container-objeto">
    ...
    <section class="fase-slide">
        <div class="historia-header-title">
            ...
            {{-- Si el objeto tiene un año registrado, lo mostramos como subtítulo --}}
            @if($objeto->anio)
            ...
            <div class="fase-content">
                ...
                <div class="fase-texto">
                    <span class="fase-num">
                        ...
                        {{-- Si la imagen tiene un año específico, lo mostramos al lado --}}
