...
@php
    ...
    // =========================================================================
    // SOLUCIÓN DE ALINEACIÓN: ÚNICA FUENTE DE VERDAD
    // =========================================================================
    // Verificamos si tu compañero ya agregó la columna 'puesto' a la base de datos
    ...
    // Extraemos la información directamente de la tabla 'equipo'
    ...
    if($equipoDB->count() > 0) {
        ...
        // Datos estáticos OG (Se usan si la base de datos está vacía)
        $miembros = [
            [
...
<div class="akira-container">
    ...
    <!-- REESTRUCTURACIÓN DE CUADRÍCULA: FILA POR FILA -->
    ...
    <ul class="team-list">
        ...
        <li style="display: grid; grid-template-columns: 1fr 1fr; gap: 50px; align-items: start;">
            <!-- Lado Izquierdo: Nombre y Biografía -->
            <div>
                {{ $miembro['nombre'] }} 
